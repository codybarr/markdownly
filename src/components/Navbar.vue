<template>
	...
	>
		...
		<div
			id="mobileNav"
			:class="['navbar-menu', { 'is-active': mobileNavActive }]"
		>
			<div class="navbar-start">
				<router-link to="/snips" class="navbar-item" activeClass="is-active"
					>Snips</router-link
				>
			...
			<div class="navbar-end">
				...
				<template v-else>
					...
					<div v-else class="navbar-item">
						<button @click.prevent="login" class="button is-info">
							<span class="icon">
